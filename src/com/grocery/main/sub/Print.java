...
public class Print extends javax.swing.JFrame {
    ...
    public Print(String sub,String pay,String bal,TableModel tableModel) throws PrinterException {
        ...
        txt_print.setText(txt_print.getText()+"*******pos*******\n");
        txt_print.setText(txt_print.getText()+"\n");
        txt_print.setText(txt_print.getText()+ "Product" + "\t" + "Price"+ "\t" + "Total" );
         ...
         txt_print.setText(txt_print.getText()+"\n");
         txt_print.setText(txt_print.getText()+"\n");
         txt_print.setText(txt_print.getText()+"        "  + "SubTotal : " + sub +  "\n");
         txt_print.setText(txt_print.getText()+"        "  + "Pay : " + pay +  "\n");
         txt_print.setText(txt_print.getText()+"        "  + "Balance : " + bal +  "\n");
         
         txt_print.setText(txt_print.getText()+"********************\n");
         txt_print.setText(txt_print.getText()+"********************\n");
         txt_print.setText(txt_print.getText()+"Thank You ..Come Again......\n");
