 ...
 * @author Gayani
 */
public class Inactive_GRN extends javax.swing.JFrame {

    /**
     * Creates new form Inactive_GRN
     */
    public Inactive_GRN() {
        initComponents();
        loadTable();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Inactive GRN", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inactive_GRN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void loadTable() {
        try {
            ResultSet rs = DB.search("SELECT * FROM `grn` where status = '0'");
