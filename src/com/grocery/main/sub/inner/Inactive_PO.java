 ...
 * @author Gayani
 */
public class Inactive_PO extends javax.swing.JFrame {

    /**
     * Creates new form Inactive_PO
     */
    public Inactive_PO() {
        initComponents();
        loadTable();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Inactive PO", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inactive_PO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void loadTable() {
        try {
            ResultSet rs = DB.search("SELECT * FROM `purchasing_order` where po_status = '0'");
